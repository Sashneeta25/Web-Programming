<!--
Matric Number: A174559
Name: Sashneeta d/o Subahar
-->
<?php
...
$record = array
  (
  'name' => " Sashneeta Subahar",
  'age' => 21,
  'sex' => "female",
  'address' => "Skudai,Johor.",
  'email' => "sashneeta@gmail.com",
  'dob' => "2000-08-25",
  'height' => 171,
  'phone' => "+6010-8292289",
  'color' => "#000000",
  'fbtwig' => "https://www.instagram.com/sashneeta_subahar/",
  'univ' => "UKM",
  'matricnum' => "a174559"
  );
...
<head>
  ...
  <style>
    ...
    body {
    height: 946px;
    background:linear-gradient(to bottom, #ff9999 0%, #cc0066 100%)fixed;
  }
...
<hr>
<input type="hidden" name="matricnum" value="a174559" value="<?php echo $record['matricnum']; ?>">
