...
<body>
  <center>
    ...
    <form action="staffs.php" method="post">
      ...
      <input name="sid" type="text" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_id']; ?>"> <br></br>
    </div>
    <div>
      <label>Name:</label>
      ...
      <label>Email:</label>
      <input name="email" type="email" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_email']; ?>"> <br></br>
    </div>
    ...
    <table border="1">
      ...
      <tr>
        ...
        <td>
          <a class="two" href="staffs.php?edit=<?php echo $readrow['fld_staff_id']; ?>">Edit</a>
          <a class="two" href="staffs.php?delete=<?php echo $readrow['fld_staff_id']; ?>" onclick="return confirm('Are you sure to delete?');">Delete</a>
        </td>
      </tr>
      <?php
      }
